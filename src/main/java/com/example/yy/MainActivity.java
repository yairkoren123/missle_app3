...
public class MainActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (the_setting_intent_data == null || the_setting_intent_size == null){
            ...
            // size icon :
            if (the_setting_intent_size.equals("Small")){
                width_icon = 30;
                height_icon = 30;
            }else if (the_setting_intent_size.equals("Medium")){
                width_icon = 40;
                height_icon = 40;
            }else if (the_setting_intent_size.equals("Large")){
                width_icon = 50;
                height_icon = 50;
            }
            // data_list :
            int list_data_from_setting;
            if (the_setting_intent_data.equals("ALL")){
                list_data_from_setting = 0;
            }else {
                list_data_from_setting = Integer.parseInt(the_setting_intent_data);
            }
...
//                intent.putExtra("height_size", height_icon);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        // from setting
       if (the_setting_dark_mode_main.equals("true")) {
